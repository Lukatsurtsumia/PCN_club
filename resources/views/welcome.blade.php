            ...
            <div class="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-2 lg:px-10">
                ...
                <div>
                    ...
                    <div data-reveal="up" data-reveal-delay="2" class="mt-6 max-w-xl space-y-4 text-base sm:text-lg leading-relaxed text-navy-700/80">
                        ...
                        <p>{{ __('Over the decades, Pugilist Club Niçois has trained numerous national and international champions while welcoming practitioners of all skill levels. The club offers English boxing classes for children, teenagers, and adults, tailored for recreation, wellness, fitness, physical conditioning, as well as competition.') }}</p>
